 ...
 * @property varchar $filename 文件地址
 * @property varchar $filedir 文件地址

 */
class OaList1 extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['procname','step1','step2','step3','filename','filedir'],'string','max'=>255],
            [['createtime'],'datetime'],
