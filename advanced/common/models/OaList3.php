 ...
 * @property varchar $filename 上传文件
 * @property varchar $filedir 上传文件
 */
class OaList3 extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['procname','step1','step2','step3','content','filedir','filename'],'string','max'=>255],
            [['createtime'],'datetime'],
